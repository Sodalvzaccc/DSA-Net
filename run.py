...
print("可用的方法名称:", list(method_map.keys()))


def parse_arguments():
    parser = argparse.ArgumentParser()

    parser.add_argument('--logger_name', type=str, default='Multimodal Intent Recognition',
                        help="Logger name for multimodal intent recognition.")

    parser.add_argument('--dataset', type=str, default='MIntRec2', help="The selected person id.")
    ...
    parser.add_argument("--save_results", action="store_true",
                        help="save final results for multimodal intent recognition.")

    parser.add_argument('--log_path', type=str, default='logs', help="Logger directory.")

    parser.add_argument('--cache_path', type=str, default='/root/autodl-tmp/model/bert-large-uncased',
